...
main() {
	...
	# panes
	set pane-border-style "bg=default fg=${bg2}"
	set pane-active-border-style "bg=default fg=${bg2}"
	set pane-border-status bottom
	set pane-border-format ""
	set pane-border-lines single

	# windows
	setw window-status-activity-style "fg=${fg},bg=default,none"
	setw window-status-separator ""
	setw window-status-style "fg=${fg},bg=default,none"
	...
	set @batt_color_charge_secondary_tier1 "default"
	set @batt_color_charge_secondary_tier2 "default"
	set @batt_color_charge_secondary_tier3 "default"
	set @batt_color_charge_secondary_tier4 "default"
	set @batt_color_charge_secondary_tier5 "default"
	set @batt_color_charge_secondary_tier6 "default"
	set @batt_color_charge_secondary_tier7 "default"
	set @batt_color_charge_secondary_tier8 "default"
	set @batt_color_status_secondary_charged "default"
	set @batt_color_status_secondary_charging "default"
	set @batt_color_status_secondary_discharging "default"
	set @batt_color_status_secondary_attached "default"
	set @batt_color_status_secondary_unknown "default"

	# prefix_highlight
	set @prefix_highlight_empty_prompt "  "
	set @prefix_highlight_prefix_prompt ""
	set @prefix_highlight_copy_prompt ""
	set @prefix_highlight_sync_prompt ""
	set @prefix_highlight_show_copy_mode 'on'
	set @prefix_highlight_show_sync_mode 'on'
	set @prefix_highlight_fg "$orange,bold"
	set @prefix_highlight_bg "default"
	set @prefix_highlight_empty_attr "fg=$blue,bold"
	set @prefix_highlight_copy_mode_attr "fg=$mint,bold"
	set @prefix_highlight_sync_mode_attr "fg=$peach,bold"
	...
	readonly prefix_highlight="#{prefix_highlight}"
	readonly battery_info="#{battery_color_fg} #{battery_icon} #{battery_percentage} "
	...
	readonly cpu_info="#{cpu_fg_color} #{cpu_icon} $cpu_pct_justified"
	readonly session_info="#[fg=$forest] #[fg=$fg]#S"
	readonly show_window_in_window_status="#[fg=$sapphire]  #W  "
	readonly show_window_in_window_status_current="#[fg=$orange,bold]  #W  "
